...
<p align="center">
  <img src="documentation/img/banner/EAVES_banner.png" alt="EAVES banner" width="100%">
</p>
...
4. **Fits** a power-law model V = c · A<sup>b</sup> to parameterize the area-volume relationship
